...
const Signup = () => {
    ...
    const idExistedCheck = () => {
      ...
      axios.post("http://localhost:4000/user/existedid",{
        id
    ...
    return (
            <form>
                <ul>
                <li><label>아이디 <input type="text" value={id} onChange={
                    (event) => {idCheck(event)}
                    }></input></label><button onClick={idExistedCheck}>중복확인</button></li>
                ...
                <li><label>비밀번호 <input type="password"  onChange={(event) => setPassword(event.target.value)}></input></label></li>
                <li><label>비밀번호 확인 <input type="password"  onChange={(event) => passwordCheck(event)}></input></label></li>
                <div class="password-mismatch hide">비밀번호가 일치하지 않습니다.</div>
                <div class="password-validate-fail hide">비밀번호는 최소 8자 이상, 알파벳과 숫자 및 특수문자를 포함해야 합니다.</div>
                <li>
                    <label>
                ...
                <li>
                    <label>
                        성별 
                        <input type="radio" name="gender" value='남' onChange={(event) => setGender(event.target.value)} />남
                        <input type="radio" name="gender" value='여' onChange={(event) => setGender(event.target.value)} />여
                    </label>
                </li>
                <li>
                    <label>
                        포지션 <input type="radio" name="position" value='FW' onChange={(event) => setPosition(event.target.value)} />FW
                              <input type="radio" name="position" value="MF" onChange={(event) => setPosition(event.target.value)} />MF
                              <input type="radio" name="position" value="DF" onChange={(event) => setPosition(event.target.value)} />DF
                              <input type="radio" name="position" value="GK" onChange={(event) => setPosition(event.target.value)} />GK
                    </label>
                </li>
                <li>
                    <label>
                ...
                <li>
                    <label>선호경기시간 <input type="time" onChange={(event) => setMatchTime(event.target.value)}></input></label>
                    <label>선호경기위치 <input type="text" onChange={(event) => setMatchLocation(event.target.value)}></input></label>
                </li>
                </ul>
